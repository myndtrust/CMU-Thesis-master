...
class EplusEnv(Env):
    ...
    def reset(self):
        ...
        eplus_working_weather_path = (eplus_working_dir + 
                                  '/' + 
                                  self._get_file_name(self._weather_path));
        ...
        copyfile(self._weather_path, eplus_working_weather_path);
                                    # Copy the weather file to the working directory
