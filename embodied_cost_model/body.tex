...
\section{Results}
    In this section the results of the methodology described above is provided. Again, the discussion is presented first by discussing the operational and embodied carbon footprints separately. The results of this research culminate by quantifying the carbon footprint of the data center based to the functional unit of provide 1 kW-year.
