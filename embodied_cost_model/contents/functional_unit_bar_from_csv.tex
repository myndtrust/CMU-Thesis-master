...
\begin{figure}
    \centering
\pgfplotstableread[col sep=comma,]{embodied_cost_model/contents/data/functional_unit.csv}\datatable
\begin{tikzpicture}
\begin{axis}[
...
\end{tikzpicture}
\caption[Carbon Footprint per Functional Unit]{Carbon Footprint per Functional Unit}
\label{fucntional_unit_bar}
\end{figure}